    ...
    return (
		<div className="md:w-1/3 mx-3 mt-20 md:ml-20 md:pr-5">
			<form className="flex flex-col" onSubmit={onSubmitForm}>
				...
				<input id="tags" className="mb-1 p-3 w-full bg-slate-200 border-2 rounded-md border-slate-300 dark:bg-midnight-800 dark:border-midnight-800 dark:text-neutral-300 focus:outline-none" placeholder="Eg: mentored, javascript, winning" onChange={(e) => setTags(e.target.value)} value={tags} />
				<ButtonLarge btnType={"submit"} value={"Submit"} />
			</form>

			<section className="hidden sm:block my-4">
				<h3 className="text-xl font-bold text-neutral-600 dark:text-neutral-200 my-5">You won't remember everything you did and neither will your manager!</h3>
